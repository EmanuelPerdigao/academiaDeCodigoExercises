...
public class LinkedList<T> implements Iterable<T> {
    ...
    {
        //new linkedList to store the transformed elements
        LinkedList newList = new LinkedList();

        //Loop all the elements in the linkedList
        for (T element: this)
        {
            //Apply the mapper function to each element
    ...
    public LinkedList<T> filter(Predicate<T> predicate)
    {
        ...
        //new linkedList to store the selected elements
        LinkedList newList = new LinkedList();
    ...
    public T reduce(BinaryOperator<T> reducer, T accumulator)
    {
        ...
        for (T element: this)
        {
            //apply the reducer function an update the accumulator
    ...
    public boolean anyMatch(Predicate<T> predicate)
    {
        ...
        for (T element:this)
        {
            //if the element passed in predicate function return true
            if(predicate.test(element))
            {
                return true;
            }
    ...
    public boolean allMatch(Predicate<T> predicate)
    {
        ...
        for (T element:this)
        {
            //if the element one of the elements didnt passed the predicate function return false (not all elements match)
            if(!predicate.test(element))
            {
                return false;
            }
